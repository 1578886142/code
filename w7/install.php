				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							<span style="color:red">本版本为离线完整版</span>
...
function tpl_install_finish() {
	...
	<div class="alert alert-warning">
		...
		<a target="_blank" class="btn btn-success" href="https://bbs.lwwweb.com">马上去注册</a>
		<a target="_blank" class="btn btn-success" href="https://bbs.lwwweb.com" target="_blank">访问应用商城首页</a>
	</div>
EOF;
	tpl_frame();
}
