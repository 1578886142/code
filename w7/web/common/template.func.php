...
function template_compile($from, $to, $inmodule = false) {
	...
	if (defined('IN_MODULE') &&
		...
		$extra_code = "<script>var we7CommonForModule = document.createElement(\"script\");we7CommonForModule.src = '//cdn.w7.cc/we7/w7windowside.js?v=1';document.body.appendChild(we7CommonForModule)
</script>";
		$content .= $extra_code;
	}
